...
StackFrame::StackFrame(Method *method, uint8_t *return_pc, StackFrame *prev, const list<Oop *> & args, vm_thread *thread, bool is_native) : method(method), return_pc(return_pc), prev(prev) {	// va_args is: Method's argument. 所有的变长参数的类型全是有类型的 Oop。因此，在**执行 code**的时候就会有类型检查～
    ...
    for (Oop * value : args) {
        ...
        if (value != nullptr && value->get_ooptype() == OopType::_BasicTypeOop
            && ((((BasicTypeOop *)value)->get_type() == Type::_LONG) || (((BasicTypeOop *)value)->get_type() == Type::_DOUBLE))) {
...
void BytecodeEngine::initial_client(InstanceKlass *new_klass, vm_thread & thread)
{
    if (new_klass->get_state() == Klass::KlassState::NotInitialized) {
        ...
        if (new_klass->get_parent() != nullptr)	// prevent this_klass is the java.lang.Object.
            BytecodeEngine::initial_client((InstanceKlass *)new_klass->get_parent(), thread);
...
void BytecodeEngine::getStatic(Field_info *new_field, stack<Oop *> & op_stack, vm_thread & thread)
{
    ...
    initial_client(new_klass, thread);
    // parse the field to RUNTIME!!
    if (new_field->get_type() == Type::_OBJECT) {
        assert(new_field->get_type_klass() != nullptr);
        initial_client(((InstanceKlass *)new_field->get_type_klass()), thread);
    }
...
InstanceOop *BytecodeEngine::MethodHandle_make(rt_constant_pool & rt_pool, int method_handle_real_index, vm_thread & thread, bool is_bootStrap_method)
{
    ...
    //todo: 这里 改为指针后，可能为导致内存不能回收的隐患
    pair<int, int> *fake_methodhandle_pair = (pair<int, int> *)(rt_pool[method_handle_real_index].second);
    ...
    switch(ref_kind) {
        case 1:{		// REF_getField
            ...
            auto field = (Field_info *)(rt_pool[ref_index-1].second);
        ...
        case 5:{		// REF_invokeVirtual
            ...
            auto method =(Method *)(rt_pool[ref_index-1].second);
...
Oop * BytecodeEngine::execute(vm_thread & thread, StackFrame & cur_frame, int thread_no) {		// do not use vector because of construction and destruction will copy all objects inside once again. list will not do this.
    ...
    while (pc < code_begin + code_length) {
        ...
        switch(*pc) {
            ...
            case 0x13:{		// ldc_w
                ...
                if (rt_pool[rtpool_index-1].first == CONSTANT_Integer) {
                    int* value = (int*)(rt_pool[rtpool_index-1].second);
                    ...
                    float* value = (float*)(rt_pool[rtpool_index-1].second);
                    ...
                    InstanceOop *stringoop = (InstanceOop *)(Oop *)(rt_pool[rtpool_index-1].second);
                    ...
                    auto klass = (Klass *)(rt_pool[rtpool_index-1].second);
            ...
            case 0x14:{		// ldc2_w
                ...
                if (rt_pool[rtpool_index-1].first == CONSTANT_Double) {
                    double* value = (double*)(rt_pool[rtpool_index-1].second);
                    ...
                    long* value = (long*)(rt_pool[rtpool_index-1].second);
            ...
            case 0x15:{		// iload
                ...
                assert(localVariableTable[index]->get_ooptype() == OopType::_BasicTypeOop && ((BasicTypeOop *)localVariableTable[index])->get_type() == Type::_INT);
            ...
            case 0x16:{		// lload
                int index = pc[1];
                assert(localVariableTable.size() > index && index > 3);
                assert(localVariableTable[index]->get_ooptype() == OopType::_BasicTypeOop && ((BasicTypeOop *)localVariableTable[index])->get_type() == Type::_LONG);
            ...
            case 0x17:{		// fload
                int index = pc[1];
                assert(localVariableTable.size() > index && index > 3);
                assert(localVariableTable[index]->get_ooptype() == OopType::_BasicTypeOop && ((BasicTypeOop *)localVariableTable[index])->get_type() == Type::_FLOAT);
            ...
            case 0x18:{		// dload
                int index = pc[1];
                assert(localVariableTable.size() > index && index > 3);
                assert(localVariableTable[index]->get_ooptype() == OopType::_BasicTypeOop && ((BasicTypeOop *)localVariableTable[index])->get_type() == Type::_DOUBLE);
		...
		sync_wcout{} << "(DEBUG) push <null> ref from localVariableTable[" << index << "], to stack." << std::endl;
            ...
            case 0x1a:{		// iload_0
                assert(localVariableTable[0]->get_ooptype() == OopType::_BasicTypeOop && ((BasicTypeOop *)localVariableTable[0])->get_type() == Type::_INT);
            ...
            case 0x1b:{		// iload_1
                assert(localVariableTable[1]->get_ooptype() == OopType::_BasicTypeOop && ((BasicTypeOop *)localVariableTable[1])->get_type() == Type::_INT);
            ...
            case 0x1c:{		// iload_2
                assert(localVariableTable[2]->get_ooptype() == OopType::_BasicTypeOop && ((BasicTypeOop *)localVariableTable[2])->get_type() == Type::_INT);
            ...
            case 0x1d:{		// iload_3
                assert(localVariableTable[3]->get_ooptype() == OopType::_BasicTypeOop && ((BasicTypeOop *)localVariableTable[3])->get_type() == Type::_INT);
            ...
            case 0x1e:{		// lload_0
                assert(localVariableTable[0]->get_ooptype() == OopType::_BasicTypeOop && ((BasicTypeOop *)localVariableTable[0])->get_type() == Type::_LONG);
            ...
            case 0x1f:{		// lload_1
                assert(localVariableTable[1]->get_ooptype() == OopType::_BasicTypeOop && ((BasicTypeOop *)localVariableTable[1])->get_type() == Type::_LONG);
            ...
            case 0x20:{		// lload_2
                assert(localVariableTable[2]->get_ooptype() == OopType::_BasicTypeOop && ((BasicTypeOop *)localVariableTable[2])->get_type() == Type::_LONG);
            ...
            case 0x21:{		// lload_3
                assert(localVariableTable[3]->get_ooptype() == OopType::_BasicTypeOop && ((BasicTypeOop *)localVariableTable[3])->get_type() == Type::_LONG);
            ...
            case 0x22:{		// fload_0
                assert(localVariableTable[0]->get_ooptype() == OopType::_BasicTypeOop && ((BasicTypeOop *)localVariableTable[0])->get_type() == Type::_FLOAT);
            ...
            case 0x23:{		// fload_1
                assert(localVariableTable[1]->get_ooptype() == OopType::_BasicTypeOop && ((BasicTypeOop *)localVariableTable[1])->get_type() == Type::_FLOAT);
            ...
            case 0x24:{		// fload_2
                assert(localVariableTable[2]->get_ooptype() == OopType::_BasicTypeOop && ((BasicTypeOop *)localVariableTable[2])->get_type() == Type::_FLOAT);
            ...
            case 0x25:{		// fload_3
                assert(localVariableTable[3]->get_ooptype() == OopType::_BasicTypeOop && ((BasicTypeOop *)localVariableTable[3])->get_type() == Type::_FLOAT);
            ...
            case 0x26:{		// dload_0
                assert(localVariableTable[0]->get_ooptype() == OopType::_BasicTypeOop && ((BasicTypeOop *)localVariableTable[0])->get_type() == Type::_DOUBLE);
            ...
            case 0x27:{		// dload_1
                assert(localVariableTable[1]->get_ooptype() == OopType::_BasicTypeOop && ((BasicTypeOop *)localVariableTable[1])->get_type() == Type::_DOUBLE);
            ...
            case 0x28:{		// dload_2
                assert(localVariableTable[2]->get_ooptype() == OopType::_BasicTypeOop && ((BasicTypeOop *)localVariableTable[2])->get_type() == Type::_DOUBLE);
            ...
            case 0x29:{		// dload_3
                assert(localVariableTable[3]->get_ooptype() == OopType::_BasicTypeOop && ((BasicTypeOop *)localVariableTable[3])->get_type() == Type::_DOUBLE);
		...
		sync_wcout{} << "(DEBUG) push <null> ref from localVariableTable[3], to stack." << std::endl;
            ...
            case 0x37:{		// lstore
                int index = pc[1];
                assert(index > 3);
                assert(op_stack.top()->get_ooptype() == OopType::_BasicTypeOop && ((BasicTypeOop *)op_stack.top())->get_type() == Type::_LONG);
            ...
            case 0x38:{		// fstore
                int index = pc[1];
                assert(index > 3);
                assert(op_stack.top()->get_ooptype() == OopType::_BasicTypeOop && ((BasicTypeOop *)op_stack.top())->get_type() == Type::_FLOAT);
		...
		sync_wcout{} << "(DEBUG) put element of type: [" << real_value->get_klass()->get_name() << "], address :[" << real_value << "] into the index [" << index
            ...
            case 0x58:{		// pop2
                ...
                if (val1->get_ooptype() == OopType::_BasicTypeOop &&		// the second type on spec
                    (((BasicTypeOop *)val1)->get_type() == Type::_LONG || ((BasicTypeOop *)val1)->get_type() == Type::_DOUBLE)) {
                    // do nothing
                } else {
            ...
            case 0x5b:{		// dup_x2
                ...
                if (val2->get_ooptype() == OopType::_BasicTypeOop &&
                    (((BasicTypeOop *)val2)->get_type() == Type::_LONG || ((BasicTypeOop *)val2)->get_type() == Type::_DOUBLE)) {
                    // case 2
                    op_stack.push(if_BasicType_then_copy_else_return_only(val1));
                    op_stack.push(val2);
                    op_stack.push(val1);
            ...
            case 0x5e:{		// dup2_x2
                ...
                if (val1->get_ooptype() == OopType::_BasicTypeOop &&
                    ...
                    if (val3->get_ooptype() == OopType::_BasicTypeOop &&
                        (((BasicTypeOop *)val3)->get_type() == Type::_LONG || ((BasicTypeOop *)val3)->get_type() == Type::_DOUBLE)) {
                        // case 3
                        op_stack.push(if_BasicType_then_copy_else_return_only(val2));
                        op_stack.push(if_BasicType_then_copy_else_return_only(val1));
                        op_stack.push(val3);
...
//				assert(method->return_type() == oop->get_klass()->get_name());
	...
	sync_wcout{} << "[Now, get out of StackFrame #" << std::dec << thread.vm_stack.size() - 1 << "]..." << std::endl;
            ...
            case 0xb2:{		// getStatic
                ...
                auto new_field = (Field_info *)(rt_pool[rtpool_index-1].second);
            ...
            case 0xba:{		// invokeDynamic
                ...
                pair<int, int>* invokedynamic_pair = (pair<int, int>*)(rt_pool[rtpool_index-1].second);
                ...
                pair<int, int>* nameAndType_pair = (pair<int, int>*)(rt_pool[name_and_type_index-1].second);
                assert(rt_pool[nameAndType_pair->first-1].first == CONSTANT_Utf8);
                assert(rt_pool[nameAndType_pair->second-1].first == CONSTANT_Utf8);
                wstring* name = (wstring*)(rt_pool[nameAndType_pair->first-1].second);					// run
                wstring* type_descriptor = (wstring*)(rt_pool[nameAndType_pair->second-1].second);		// ()Ljava/lang/Runnable;
//				std::wcout << name << " " << type_descriptor << std::endl;	// delete
                ...
                for (int i = 0; i < fake_method_struct.num_bootstrap_arguments; i ++) {
                    ...
                    pair<int, PVOID> _pair = rt_pool[arg_index-1];
//					std::wcout << _pair.first << std::endl;		// delete
                    switch(_pair.first) {
                        case CONSTANT_String:{
                            callsite_args.push_back((Oop *)(_pair.second));
                            break;
                        }
                        case CONSTANT_Class:{
                            callsite_args.push_back(((Klass *)(_pair.second))->get_mirror());
                            break;
                        }
                        case CONSTANT_Integer:{
                            callsite_args.push_back(new IntOop(*((int*)(_pair.second))));
                            break;
                        }
                        case CONSTANT_Float:{
                            callsite_args.push_back(new FloatOop(*((float*)(_pair.second))));
                            break;
                        }
                        case CONSTANT_Long:{
                            callsite_args.push_back(new LongOop(*((long*)(_pair.second))));
                            break;
                        }
                        case CONSTANT_Double:{
                            callsite_args.push_back(new DoubleOop(*((double*)(_pair.second))));
                            break;
                        }
...
//							std::wcout << toString((InstanceOop *)temp, &thread) << std::endl;			// delete
                        ...
                        case CONSTANT_MethodType:{
                            wstring* method_type_descriptor = (wstring*)(_pair.second);
...
//				std::wcout << toString(callsite, &thread) << std::endl;		// delete
            ...
            case 0xbb:{		// new // only malloc
                ...
                initial_client(real_klass, thread);
...
//							pthread_mutex_unlock(&_all_thread_wait_mutex);
	...
	sync_wcout{} << "[Now, get out of StackFrame #" << std::dec << thread.vm_stack.size() - 1 << "]..." << std::endl;
            ...
            case 0xc1:{		// instanceof
                ...
                int rtpool_index = ((pc[1] << 8) | pc[2]);
                assert(rt_pool[rtpool_index-1].first == CONSTANT_Class);
                auto klass = (Klass *)(rt_pool[rtpool_index-1].second);		// constant_pool index
...
//						op_stack.push(ref);		// re-push.		// "op_stack will not change if op_stack's top is null."
            ...
            case 0xc5:{		// multianewarray
                ...
                for (int i = 0; i < dimensions; i ++) {
                    ...
                    assert(count->get_ooptype() == OopType::_BasicTypeOop && ((BasicTypeOop *)count)->get_type() == Type::_INT);
