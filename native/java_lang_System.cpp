...
void JVM_InitProperties(list<Oop *> & _stack){		// static
    ...
    wstring rtjar_folder = utf8_to_wstring("C:\\Program Files\\Java\\jdk1.8.0_161\\jre\\lib\\");
    //todo: vm的 properties
    ...
    thread.add_frame_and_execute(hashtable_put, {prop, java_lang_string::intern(L"java.class.path"), java_lang_string::intern(pwd + L"\\;" + sun_src+L"\\;")});		 // TODO: need modified.
    //todo: 新增属性
