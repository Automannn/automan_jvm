...
#ifndef AUTOMAN_JVM_CLASS_PARSER_H
#define AUTOMAN_JVM_CLASS_PARSER_H
...
// aux function
int peek_attribute(u2 attribute_name_index, cp_info **constant_pool);
...
#endif //AUTOMAN_JVM_CLASS_PARSER_H
